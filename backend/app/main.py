...
logger.info("EPO OPS KEY loaded: %s", bool(settings.epo_ops_consumer_key))
logger.info("EPO OPS SECRET loaded: %s", bool(settings.epo_ops_consumer_secret))
...
# ======================================================
# OPENAPI — ENABLE AUTHORIZE BUTTON
# ======================================================
def custom_openapi():
    ...
    # IMPORTANT: apply security globally
...
# ROUTER REGISTRATION
# ======================================================
# NOTE: auth_router ALREADY has prefix="/auth"
...
app.include_router(internal_knowledge_router, prefix="/api", tags=["internal"])
