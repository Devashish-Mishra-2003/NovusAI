      ...
      <Box style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
        <Container size="lg" py={40} style={{ width: '100%' }}>
          <SimpleGrid cols={{ base: 1, md: 3 }} spacing={50} style={{ alignItems: 'stretch' }}>
            ...
            {/* Left Column: Profile & Security (Now Sized to Match Vault) */}
            <Paper 
              withBorder 
              p={40} 
              radius="xl" 
            ...
            >
              <Stack gap="xl">
                <Box>
                  ...
                  <Group gap={8} mt={5}>
                    <Badge variant="dot" color="blue" size="sm">ID: {user.id ? user.id.toString().padStart(5, '0') : "GEN-01"}</Badge>
                    <Badge variant="light" color="green" leftSection={<IconCircleCheck size={10}/>} size="sm">Active</Badge>
                  </Group>
                </Box>
                ...
                <Stack gap="sm">
                  ...
                  <Group wrap="nowrap" gap="sm">
                    <ThemeIcon variant="transparent" color="blue" size="sm"><IconMail size={16} /></ThemeIcon>
                    <Text size="sm" fw={500} truncate>{user.email}</Text>
                  </Group>
                  <Group wrap="nowrap" gap="sm">
                    <ThemeIcon variant="transparent" color="blue" size="sm"><IconBuildingSkyscraper size={16} /></ThemeIcon>
                    <Text size="sm" fw={500}>{user.company_name || "Independent Researcher"}</Text>
                  </Group>
                  <Group wrap="nowrap" gap="sm">
                    <ThemeIcon variant="transparent" color="blue" size="sm"><IconLock size={16} /></ThemeIcon>
                    <Badge color="blue" variant="outline" radius="sm" size="xs">{(user.role || "user").toUpperCase()}</Badge>
                  </Group>
                </Stack>
              </Stack>
            ...
            {/* Right Column: Knowledge Vault (Symmetric to Left Paper) */}
            <Box style={{ gridColumn: 'span 2' }}>
              ...
              >
                ...
                <Group gap="md">
                    <Button variant="default" radius="xl" px="xl" disabled>Select Files</Button>
                    <Button variant="filled" color="blue" radius="xl" px="xl" disabled>Initialize Vault</Button>
                </Group>
              </Paper>
            </Box>
